...
export async function syncUserToLocalDB(userInfo) {
    ...
    console.log('[syncUserToLocalDB] Syncing user:', {
        sub: userInfo.sub,
    ...
    if (!user) {
        ...
        console.log('[syncUserToLocalDB] Created new user:', { _id: user._id, externalUserId: user.externalUserId });
    } else {
        ...
        if (!user.externalUserId || user.externalUserId === user._id.toString()) {
            ...
            console.log('[syncUserToLocalDB] Fixed externalUserId:', { 
                _id: user._id, 
                oldExternalUserId: user.externalUserId,
                newExternalUserId: userId 
            });
            await user.save();
        }
        ...
        console.log('[syncUserToLocalDB] Updated existing user:', { 
            _id: user._id, 
