// app/(auth)/(main)/search/teams/SearchTeamsClient.client.js
'use client';
...
export default function SearchTeamsClient({ initialQuery, userId, isAdmin }) {
    ...
    const fetchResults = useCallback(async (cursor = null, isLoadMore = false) => {
        ...
        try {
            const url = `/api/search/teams?q=${encodeURIComponent(initialQuery)}${cursor ? `&cursor=${cursor}` : ''}`;
        ...
        <div className="space-y-4 pb-4">
            ...
            {items.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 font-medium">Không tìm thấy nhóm nào</p>
                        ...
                        {items.map((team) => (
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-blue-100 border border-blue-200 flex items-center justify-center group-hover:bg-blue-200 transition-colors">
            ...
            <div className="pt-6 border-t border-gray-200">
                <div className="flex items-center gap-4 text-sm">
                    ...
                    <Link
                        href={`/search/projects?q=${encodeURIComponent(initialQuery)}`}
