                    ...
                    {days.map((day, idx) => {
                        ...
                        return (
                            <div
                                ...
                                className={`min-h-32 max-h-64 flex flex-col p-2 border-b border-r border-gray-100 transition-colors ${
                            ...
                            >
                                ...
                                <div className="space-y-1 overflow-y-auto custom-scrollbar flex-1 min-h-0">
                                    {dayTasks.length === 0 ? (
                                        <div className="text-xs text-gray-400 text-center py-2">Không có</div>
                                    ) : (
                                        dayTasks.map((t) => (
                                            <div
                                                ...
                                                className={`rounded-md px-2 py-1.5 text-xs font-medium cursor-grab active:cursor-grabbing border transition-all hover:shadow-sm flex-shrink-0 ${getPriorityColor(t.priority)}`}
                                                title={t.title}
                                            >
