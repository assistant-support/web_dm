// components/team/TeamHeader.server.js
// Mục đích: Header cho team detail page (Server Component)
                    ...
                    {isManager && (
                        <div className="flex-shrink-0">
                            <Link
                                ...
                                className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--brand-600)] focus:ring-offset-2 transition-all"
                            >
